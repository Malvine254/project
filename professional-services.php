  ...
  <div class="container content-container mt-5">
    <div class="row">
        ...
        <div class="col-md-6 column">
            <h1 class="text-left">Professional Services</h1>
            <h5 class="text-left">At our core, we deliver the solutions and knowledge needed to effectively oversee essential IT services, freeing you to concentrate on strategic endeavors.</h5>
            <img src="images/services/professional (1).png" alt="" class="img-fluid">
        </div>
        <!-- Column Two -->
        <div class="col-md-6 column mt-3">
            <p class="text-left">Whether your goals involve generating fresh revenue streams, optimizing work processes for greater efficiency, or revolutionizing customer interactions, we harness the power of managed services in collaboration with top technology providers.</p>
            <br>
            <p class="text-left">Our approach is centered on comprehending your desired business objectives and accelerating your progress toward achieving them.</p>
            <br
            <div class="col-md-6 column text-left mt-3 mb-3">
            <h4>Redefine your IT landscape with Armely's expert guidance</h4>
            <p class="text-left">With our support, your business stays connected and secure, enabling you to thrive in today's dynamic landscape</p>
            <ul class="list-unstyled text-left">
                ...
                <a href="#" class="btn default-button-color btn-primary btn-advisory mt-3 mb-3">Professional Services</a>
                </div>
        </div>
    </div>
</div>
                ...
                <form  method="post">
                    <div class="form-row">
                      <div class="col-md-6 mb-1">
                        ...
                        <input name ="name" type="text" class="form-control  edit-input  edit-input-valid" id="validationServer01" placeholder="First name" value="Mark" required>
                      </div>
                      <div class="col-md-6 mb-1">
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <select name ="service_name" type="text" class="form-control edit-input"  placeholder="Organization Name" required>
                      ...
                      <div class="col-md-12 mb-3">
                        ...
                        <textarea name ="message" rows="5" type="text" class="form-control " id="validationServer05" placeholder="Message..." required></textarea>
                        <div class="invalid-feedback">
                          Please provide a valid Message.
                        </div>
                      </div>
                    </div>
                    <button name ="consultation_btn" class="btn btn-primary default-button-color" type="submit">Send Message</button>
                  </form>  
            </div>
    </div>
</div>
