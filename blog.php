...
<!-- end of services floating screen and company floating screen -->
  ...
  ?>   
        ...
        <div class="col-md-4">
          ...
          <div id="blog-articles"> <?php  displayBlogs(); ?></div>
         
          
        <div>
            <a id='load-more' class="text-link"> SEE MORE BLOG POSTS <i class="fa fa-angle-right"></i></a>
      </div>
    </div>
  </div>
</div>
...
<div id="customModal" class="modal-for-share">
  ...
  // Show the first 10 articles initially
  $("#blog-articles .blog-article:lt(10)").show();

  // Set a variable to keep track of the number of articles shown
  var articlesShown = 10;

  // Hide the button if the number of articles is less than or equal to 10
  if ($("#blog-articles .blog-article").length <= articlesShown) {
      $("#load-more").hide();
  }
  ...
  $("#load-more").click(function() {
      articlesShown += 10;
      $("#blog-articles .blog-article:lt(" + articlesShown + ")").show();
